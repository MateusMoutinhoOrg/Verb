...
- A function field's factory returns a **closure**; a plain struct field's factory returns a **value** (e.g. `ArgvLibFactory` in `bootstrap/adapters/standard/`).
